export default async function About() {
  ...
  return (
    ...
    <p>
      <strong>Last Modified June 27, 2023.</strong>
    </p>
     <p>
      Thank you for choosing Faux Network. In these terms of use, &lsquo;us&rsquo; &lsquo;we&rsquo; or &lsquo;our&rsquo; means
      Rgoegues Lab ATF ProRoute Pty Ltd (ACN 617 845 468) and our related bodies corporate. A reference to
      &lsquo;you&rsquo; or &lsquo;user&rsquo; means you. In these terms of use, &lsquo;Services&rsquo; means our
      website, <a href="http://www.faux.network/">http:///www.faux.network</a>, and
      related websites, (the &lsquo;Website&rsquo;), the Faux Network application, and
    ...
    <p>
      ...
      available at http://www.faux.network/privacy.
    </p>
    <p>
    ...
    <p>
      ...
      or accessible through, the Services (&lsquo;Faux Network Content&rsquo;).
    </p>
    <p>
      Your use of the Services and use of and access to any Faux Network Content does not grant
      or transfer any rights, title or interest to you in relation to the Services or the
      Faux Network Content. However we do grant you a licence to access the Services and view the
      Faux Network Content on the terms and conditions set out in these terms of use and, where
      applicable, as expressly authorised by us and/or our third party licensors.
    </p>
    <p>
      Any reproduction or redistribution of any of the Services or the Faux Network Content is
      prohibited and may result in civil and criminal penalties. In addition, you must not
      copy the Faux Network Content to any other server, location or support for publication,
      reproduction or distribution is expressly prohibited.
    </p>
    <p>
      All other use, copying or reproduction of any of the Services, the Faux Network Content or
      any part of any of the Services or the Faux Network Content is prohibited, except to the
    ...
    <p>The Services are for your personal use only. You must not, as applicable:</p>
      ...
      <br/>
        ...
        Faux Network Content, software, products or services contained within any of the
        Services;
    ...
    <p>
      ...
      <br/>
        ...
        Faux Network or ProRoute website to distribute software viruses or other harmful
        programs; or
    ...
    <p>
      You must not use any of the Services, or any of the Faux Network Content, to further any
    ...
    <p>
      ...
      representations about any of the Services or the Faux Netowrk Content, including but not
    ...
    <p>
      ...
      or all of the Services, any Faux Network Content, or any feature of the Services at any
    ...
    <p>
      ...
      <a href="mailto:info@rogueslab.com" title="info@rogueslab.com">
            info@rogueslab.com
      </a>
